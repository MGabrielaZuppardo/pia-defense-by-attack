...
from instruction_attack_defense_tools_pt_base import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="data/crafted_instruction_data_qa_pt.json")
    ...
    parser.add_argument("--log_path", type=str, default="logs/debug_pt_base.txt")
