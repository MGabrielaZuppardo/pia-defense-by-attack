# Experimentos exp03 (fakecomt) — instrução EN, base EN, injeção PT
...
$experiments = @(
    @{
        ...
        log      = "logs/qwen25_7b/pt_so_injecao/exp03_qa_pt_so_inj_fakecomt_qwen25_7b.txt"
        label    = "qwen2.5:7b"
    },
    @{
        model    = "ollama:llama3.1:8b-instruct-q8_0"
        log      = "logs/llama31_8b/pt_so_injecao/exp03_qa_pt_so_inj_fakecomt_llama31_8b.txt"
        label    = "llama3.1:8b-instruct-q8_0"
    },
    @{
        model    = "ollama:tinyllama:latest"
        log      = "logs/tinyllama_1b/pt_so_injecao/exp03_qa_pt_so_inj_fakecomt_tinyllama.txt"
...
Write-Host "`nTodos os exp03 concluidos." -ForegroundColor Green
