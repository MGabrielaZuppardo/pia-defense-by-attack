# Experimentos exp01 (sem defesa) — instrução PT, base PT, injeção PT
...
$experiments = @(
    @{
        ...
        log      = "logs/qwen25_7b/pt_tudo/exp01_qa_pt_tudo_sem_defesa_qwen25_7b.txt"
        label    = "qwen2.5:7b"
    },
    @{
        model    = "ollama:llama3.1:8b-instruct-q8_0"
        log      = "logs/llama31_8b/pt_tudo/exp01_qa_pt_tudo_sem_defesa_llama31_8b.txt"
        label    = "llama3.1:8b-instruct-q8_0"
    },
    @{
        model    = "ollama:tinyllama:latest"
        log      = "logs/tinyllama_1b/pt_tudo/exp01_qa_pt_tudo_sem_defesa_tinyllama.txt"
...
Write-Host "`nTodos os exp01 pt_tudo concluidos." -ForegroundColor Green
