# Experimentos exp03 (fakecomt) — instrução PT, base PT, injeção PT — dataset NLLB
...
$experiments = @(
    @{
        ...
        log   = "logs/qwen25_7b/nllb_pt_tudo/exp03_qa_nllb_pt_tudo_fakecomt_qwen25_7b.txt"
        label = "qwen2.5:7b"
    },
    @{
        model = "ollama:llama3.1:8b-instruct-q8_0"
        log   = "logs/llama31_8b/nllb_pt_tudo/exp03_qa_nllb_pt_tudo_fakecomt_llama31_8b.txt"
...
Write-Host "`nTodos os exp03 nllb_pt_tudo concluidos." -ForegroundColor Green
