# Experimentos exp01 (sem defesa) — instrução PT, injeção PT
...
$experiments = @(
    @{
        ...
        log      = "logs/qwen25_7b/pt_so_injecao/exp01_qa_pt_so_inj_sem_defesa_qwen25_7b.txt"
        label    = "qwen2.5:7b"
    },
    @{
...
Write-Host "`nTodos os exp01 concluidos." -ForegroundColor Green
